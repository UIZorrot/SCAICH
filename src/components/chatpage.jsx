...
import { Input, Button, Typography, Spin, List } from "antd";
...
function ChatModal({ visible, paperId, source, onClose }) {
    ...
    useEffect(() => {
        ...
        newSocket.on("session_id", (data) => {
            ...
            setMessages((prev) => [
                ...prev,
                { role: "system", content: "Agent connected" },
            ]);
            setLoading(false);
        });
    ...
    return (
        <div style={{ padding: 16, display: "flex", flexDirection: "column", height: "500px" }}>
            {error && (
                        ...
                        >
                            <div style={{ width: "100%" }}>
                                {item.role === "assistant" ? (
                                    ...
                                    <Paragraph style={{ margin: 0, fontSize: 14, color: "#333" }}>
                                        {item.content}
                                    </Paragraph>
                                )}
                            </div>
